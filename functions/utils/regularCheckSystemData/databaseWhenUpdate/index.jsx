import dataUpdateConfig from "@/functions/utils/regularCheckSystemData/dataUpdateChecker/dataUpdateConfig";
...
const DatabaseWhenUpdate = async (pathname, req) => {
  if (req.method == "POST" && pathname) {
    ...
    if (
      systemDataRecord.length >= 1 ||
      systemDataRecord != undefined ||
      systemDataRecord != null
    ) {
