...
import CookieTimeUpdate from "@/functions/utils/regularCheckSystemData/cookieTimeUpdate";
...
const NewSystemDataProcess = async (
  ...
  try {
    ...
    //2.3 #### LOCALSTORAGE KONTROLÜ VE İŞLEMLERİ ####################################################################
      ...
      return {
        error: null,
        data: JSON.parse(checkLocalStor),
        status: "success",
        storageType: storageType,
      };
    }
